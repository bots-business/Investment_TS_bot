...
let wallet = User.getProperty("permdogewallet");
...
Bot.sendMessage("*...Generating your deposit address...*")
Bot.sendMessage("⚠️ _If you send less than 10 DOGE, your deposit will be ignored!_\n\n✅ *Send the amount you want to invest to the following address:*")
let permtrxwallet = User.getProperty("permdogewallet");
Bot.sendMessage("`" + wallet + "`") ;}
}else{
  Bot.runCommand("/createWalletDoge");
}
